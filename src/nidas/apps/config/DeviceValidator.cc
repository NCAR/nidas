...
{"CDP", "/dev/ttyS", 5, 12, DeviceValidator::_DeviceDefinition::SERIAL},
{"CDP016", "/dev/ttyS", 5, 12, DeviceValidator::_DeviceDefinition::SERIAL},
{"CDP058", "/dev/ttyS", 5, 12, DeviceValidator::_DeviceDefinition::SERIAL},
