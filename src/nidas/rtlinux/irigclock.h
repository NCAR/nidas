...
#define IRIG_GET_CLOCK	_IOR(IRIG_IOC_MAGIC,3,struct rtl_timeval)
#define IRIG_SET_CLOCK	_IOW(IRIG_IOC_MAGIC,4,struct rtl_timeval)
#define IRIG_OVERRIDE_CLOCK _IOW(IRIG_IOC_MAGIC,5,struct rtl_timeval)
