...
/* static */
n_u::Mutex RTL_DevIoctlStore::instanceMutex;
...
RTL_DevIoctl*  RTL_DevIoctlStore::getDevIoctl(const string& prefix,
	int devNum) throw(n_u::IOException)
{
    /*
...
RTL_DevIoctl*  RTL_DevIoctlStore::getDevIoctl(const string& prefix,
	int boardNum, int firstPort) throw(n_u::IOException)
{
    ...
    throw n_u::IOException(infifo,"open","file not found");
}
