...
bool WisardMote::process(const Sample * samp,
...
void WisardMote::addSampleTag(SampleTag *
		stag) throw(n_u::InvalidParameterException)
		{
	for (int i = 0;; i++) {
		...
		int nv =
			sizeof (_samps[i].variables) / sizeof (_samps[i].variables[0]);
		...
		for (int j = 0; j < nv; j++) {
			...
			//ddd plot-range
			string aval =
				Project::getInstance()->expandString(vinf.plotrange);
 ...
 */
int WisardMote::readHead(const unsigned char *&cp,
		const unsigned char *eos)
{
	...
	const unsigned char *colon =
		(const unsigned char *)::memchr(cp, ':', eos - cp);
	if (!colon)
		return -1;
		...
		const unsigned char *eos)
{
	...
	if (eos - 4 < sos) {
		n_u::Logger::getInstance()->log(LOG_ERR,
				"Message length is too short --- len= %d",
				eos - sos);
		return 0;
	}
		...
		dsm_time_t ttag)
{
	for (int i = 0; i < 6; i++) {
		...
		if (val != missValue) {
			if (i == 0 || i == 2)
				_data.push_back(val / 1000.0);  //mili-voltage to volt
				else
		...
		dsm_time_t ttag)
{
	for (int i = 0; i < 2; i++) {
		...
		if (val != missValueSigned) {
			if (i == 0)
				_data.push_back(val / 10.0);    // RPile
				else
					_data.push_back(val / 100.0);   // tcase
		} else
			_data.push_back(floatNAN);
	}
	return cp;
...
SampInfo WisardMote::_samps[] = {
		{0x0E, {
				{"Tdiff", "secs", "Time difference, adam-mote", "$ALL_DEFAULT",
						true}
				,
				{"Tdiff2", "secs", "Time difference, adam-mote-first_diff",
						"$ALL_DEFAULT", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		,
		{0x2C, {
				{"Vheat.a", "V", "Soil Thermal, heat volt", "$VHEAT_RANGE",
						true}
				,
				{"Vpile.on.a", "microV", "Soil Thermal, transducer volt",
						"$VPILE_RANGE", true}
				,
				{"Vpile.off.a", "microV", "Soil Thermal, heat volt",
						"$VPILE_RANGE", true}
				,
				{"Tau63.a", "secs", "Soil Thermal, time diff", "$TAU63_RANGE",
						true}
				,
				{"lambdasoil.a", "W/mDegk", "Thermal property",
						"$LAMBDA_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		,
		{0x2D, {
				{"Vheat.b", "V", "Soil Thermal, heat volt", "$VHEAT_RANGE",
						true}
				,
				{"Vpile.on.b", "microV", "Soil Thermal, transducer volt",
						"$VPILE_RANGE", true}
				,
				{"Vpile.off.b", "microV", "Soil Thermal, heat volt",
						"$VPILE_RANGE", true}
				,
				{"Tau63.b", "secs", "Soil Thermal, time diff", "$TAU63_RANGE",
						true}
				,
				{"lambdasoil.b", "W/mDegk", "Thermal property",
						"$LAMBDA_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		,
		{0x2E, {
				{"Vheat.c", "V", "Soil Thermal, heat volt", "$VHEAT_RANGE",
						true}
				,
				{"Vpile.on.c", "microV", "Soil Thermal, transducer volt",
						"$VPILE_RANGE", true}
				,
				{"Vpile.off.c", "microV", "Soil Thermal, heat volt",
						"$VPILE_RANGE", true}
				,
				{"Tau63.c", "secs", "Soil Thermal, time diff", "$TAU63_RANGE",
						true}
				,
				{"lambdasoil.c", "W/mDegk", "Thermal property",
						"$LAMBDA_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		,
		{0x2F, {
				{"Vheat.d", "V", "Soil Thermal, heat volt", "$VHEAT_RANGE",
						true}
				,
				{"Vpile.on.d", "microV", "Soil Thermal, transducer volt",
						"$VPILE_RANGE", true}
				,
				{"Vpile.off.d", "microV", "Soil Thermal, heat volt",
						"$VPILE_RANGE", true}
				,
				{"Tau63.d", "secs", "Soil Thermal, time diff", "$TAU63_RANGE",
						true}
				,
				{"lambdasoil.d", "W/mDegk", "Thermal property",
						"$LAMBDA_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		{0x54, {
				{"Rsw.in.a", "W/m^2", "Incoming Short Wave", "$RSWIN_RANGE",
						true}
				,
				{0, 0, 0, 0, true}
		}
		...
		,
		{0x55, {
				{"Rsw.in.b", "W/m^2", "Incoming Short Wave", "$RSWIN_RANGE",
						true}
				,
				{0, 0, 0, 0, true}
		}
		...
		,
		{0x56, {
				{"Rsw.in.c", "W/m^2", "Incoming Short Wave", "$RSWIN_RANGE",
						true}
				,
				{0, 0, 0, 0, true}
		}
		...
		,
		{0x57, {
				{"Rsw.in.d", "W/m^2", "Incoming Short Wave", "$RSWIN_RANGE",
						true}
				,
				{0, 0, 0, 0, true}
		}
		...
		,
		{0x58, {
				{"Rsw.out.a", "W/m^2", "Outgoing Short Wave", "$RSWOUT_RANGE",
						true}
				,
				{0, 0, 0, 0, true}
		}
		...
		,
		{0x59, {
				{"Rsw.out.b", "W/m^2", "Outgoing Short Wave", "$RSWOUT_RANGE",
						true}
				,
				{0, 0, 0, 0, true}
		}
		...
		,
		{0x5A, {
				{"Rsw.out.c", "W/m^2", "Outgoing Short Wave", "$RSWOUT_RANGE",
						true}
				,
				{0, 0, 0, 0, true}
		}
		...
		,
		{0x5B, {
				{"Rsw.out.d", "W/m^2", "Outgoing Short Wave", "$RSWOUT_RANGE",
						true}
				,
				{0, 0, 0, 0, true}
		}
		...
		{0x5C, {
				{"Rpile.in.a", "W/m^2",
						"Epply pyrgeometer thermopile, incoming", "$RPILE_RANGE",
						true}
				,
				{"Tcase.in.a", "degC", "Epply case temperature, incoming",
						"$TCASE_RANGE", true}
				,
				{"Tdome1.in.a", "degC", "Epply dome temperature #1, incoming",
						"$TDOME_RANGE", true}
				,
				{"Tdome2.in.a", "degC", "Epply dome temperature #2, incoming",
						"$TDOME_RANGE", true}
				,
				{"Tdome3.in.a", "degC", "Epply dome temperature #3, incoming",
						"$TDOME_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		{0x5D, {
				{"Rpile.in.b", "W/m^2",
						...
						true}
				,
				{"Tcase.in.b", "degC", "Epply case temperature, incoming",
						"$TCASE_RANGE", true}
				,
				{"Tdome1.in.b", "degC", "Epply dome temperature #1, incoming",
						"$TDOME_RANGE", true}
				,
				{"Tdome2.in.b", "degC", "Epply dome temperature #2, incoming",
						"$TDOME_RANGE", true}
				,
				{"Tdome3.in.b", "degC", "Epply dome temperature #3, incoming",
						"$TDOME_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		{0x5E, {
				{"Rpile.in.c", "W/m^2",
						...
						true}
				,
				{"Tcase.in.c", "degC", "Epply case temperature, incoming",
						"$TCASE_RANGE", true}
				,
				{"Tdome1.in.c", "degC", "Epply dome temperature #1, incoming",
						"$TDOME_RANGE", true}
				,
				{"Tdome2.in.c", "degC", "Epply dome temperature #2, incoming",
						"$TDOME_RANGE", true}
				,
				{"Tdome3.in.c", "degC", "Epply dome temperature #3, incoming",
						"$TDOME_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		{0x5F, {
				{"Rpile.in.d", "W/m^2",
						...
						true}
				,
				{"Tcase.in.d", "degC", "Epply case temperature, incoming",
						"$TCASE_RANGE", true}
				,
				{"Tdome1.in.d", "degC", "Epply dome temperature #1, incoming",
						"$TDOME_RANGE", true}
				,
				{"Tdome2.in.d", "degC", "Epply dome temperature #2, incoming",
						"$TDOME_RANGE", true}
				,
				{"Tdome3.in.d", "degC", "Epply dome temperature #3, incoming",
						"$TDOME_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		{0x60, {
				{"Rpile.out.a", "W/m^2",
						"Epply pyrgeometer thermopile, outgoing", "$RPILE_RANGE",
						true}
				,
				{"Tcase.out.a", "degC", "Epply case temperature, outgoing",
						"$TCASE_RANGE", true}
				,
				{"Tdome1.out.a", "degC", "Epply dome temperature #1, outgoing",
						"$TDOME_RANGE", true}
				,
				{"Tdome2.out.a", "degC", "Epply dome temperature #2, outgoing",
						"$TDOME_RANGE", true}
				,
				{"Tdome3.out.a", "degC", "Epply dome temperature #3, outgoing",
						"$TDOME_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		{0x61, {
				{"Rpile.out.b", "W/m^2",
						...
						true}
				,
				{"Tcase.out.b", "degC", "Epply case temperature, outgoing",
						"$TCASE_RANGE", true}
				,
				{"Tdome1.out.b", "degC", "Epply dome temperature #1, outgoing",
						"$TDOME_RANGE", true}
				,
				{"Tdome2.out.b", "degC", "Epply dome temperature #2, outgoing",
						"$TDOME_RANGE", true}
				,
				{"Tdome3.out.b", "degC", "Epply dome temperature #3, outgoing",
						"$TDOME_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		{0x62, {
				{"Rpile.out.c", "W/m^2",
						...
						true}
				,
				{"Tcase.out.c", "degC", "Epply case temperature, outgoing",
						"$TCASE_RANGE", true}
				,
				{"Tdome1.out.c", "degC", "Epply dome temperature #1, outgoing",
						"$TDOME_RANGE", true}
				,
				{"Tdome2.out.c", "degC", "Epply dome temperature #2, outgoing",
						"$TDOME_RANGE", true}
				,
				{"Tdome3.out.c", "degC", "Epply dome temperature #3, outgoing",
						"$TDOME_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		{0x63, {
				{"Rpile.out.d", "W/m^2",
						...
						true}
				,
				{"Tcase.out.d", "degC", "Epply case temperature, incoming",
						"$TCASE_RANGE", true}
				,
				{"Tdome1.out.d", "degC", "Epply dome temperature #1, incoming",
						"$TDOME_RANGE", true}
				,
				{"Tdome2.out.d", "degC", "Epply dome temperature #2, incoming",
						"$TDOME_RANGE", true}
				,
				{"Tdome3.out.d", "degC", "Epply dome temperature #3, incoming",
						"$TDOME_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		{0x64, {
				{"Rpile.in.akz", "W/m^2",
						"K&Z pyrgeometer thermopile, incoming", "$RPILE_RANGE", true}
				,
				{"Tcase.in.akz", "degC", "K&Z case temperature, incoming",
						"$TCASE_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		{0x65, {
				{"Rpile.in.bkz", "W/m^2",
						"K&Z pyrgeometer thermopile, incoming", "$RPILE_RANGE", true}
				,
				{"Tcase.in.bkz", "degC", "K&Z case temperature, incoming",
						"$TCASE_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		{0x66, {
				{"Rpile.in.ckz", "W/m^2",
						"K&Z pyrgeometer thermopile, incoming", "$RPILE_RANGE", true}
				,
				{"Tcase.in.ckz", "degC", "K&Z case temperature, incoming",
						"$TCASE_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		{0x67, {
				{"Rpile.in.dkz", "W/m^2",
						"K&Z pyrgeometer thermopile, incoming", "$RPILE_RANGE", true}
				,
				{"Tcase.in.dkz", "degC", "K&Z case temperature, incoming",
						"$TCASE_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		{0x68, {
				{"Rpile.out.akz", "W/m^2",
						"K&Z pyrgeometer thermopile, outgoing", "$RPILE_RANGE", true}
				,
				{"Tcase.out.akz", "degC", "K&Z case temperature, outgoing",
						"$TCASE_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		{0x69, {
				{"Rpile.out.bkz", "W/m^2",
						"K&Z pyrgeometer thermopile, outgoing", "$RPILE_RANGE", true}
				,
				{"Tcase.out.bkz", "degC", "K&Z case temperature, outgoing",
						"$TCASE_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		{0x6A, {
				{"Rpile.out.ckz", "W/m^2",
						"K&Z pyrgeometer thermopile, outgoing", "$RPILE_RANGE", true}
				,
				{"Tcase.out.ckz", "degC", "K&Z case temperature, outgoing",
						"$TCASE_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		{0x6B, {
				{"Rpile.out.dkz", "W/m^2",
						"K&Z pyrgeometer thermopile, outgoing", "$RPILE_RANGE", true}
				,
				{"Tcase.out.dkz", "degC", "K&Z case temperature, outgoing",
						"$TCASE_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		{0x6C, {
				{"Rsw.net.a", "W/m^2",
						"difference values for up-down looking short-wave",
						"$CNR2_RANGE", true}
				,
				{"Rlw.net.a", "W/m^2",
						"difference values for up-down looking long-wave",
						"$CNR2_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		{0x70, {
				{"Rsw.dfs.a", "W/m^2", "Rsw-diffuse/shadow band Licor",
						"$RSWDFS_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		,
		{0x71, {
				{"Rsw.dfs.b", "W/m^2", "Rsw-diffuse/shadow band Licor",
						"$RSWDFS_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		,
		{0x72, {
				{"Rsw.dfs.c", "W/m^2", "Rsw-diffuse/shadow band Licor",
						"$RSWDFS_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
		...
		,
		{0x73, {
				{"Rsw.dfs.d", "W/m^2", "Rsw-diffuse/shadow band Licor",
						"$RSWDFS_RANGE", true}
				,
				{0, 0, 0, 0, true}
		}
