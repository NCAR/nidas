...
void PSQLSampleOutput::connected(IOChannel* sock) throw()
{
...
void PSQLSampleOutput::addSampleTag(const SampleTag* tag)
    	throw(atdUtil::InvalidParameterException)
{
	...
	ostringstream errst;
	errst << tag->getRate();
    	throw atdUtil::InvalidParameterException(getName(),"addSampleTag",
...
void PSQLSampleOutput::createTables() throw(atdUtil::IOException)
{
    submitCommand(
...
/* -------------------------------------------------------------------- */
void PSQLSampleOutput::initializeGlobalAttributes() throw(atdUtil::IOException)
{
